...
test("THE KUTÚZOV CASE: the fold makes the real novel visible to an unaccented claim — against the real bytes", { skip: SKIP || (!existsSync("/Users/mlacy/Documents/3.0/eoreader7/native/eval/fixtures/corpus/pg2600-war-and-peace.txt") && "the pg2600 War and Peace fixture is not beside this repo") }, () => {
...
import { buildSelectMessages, foldSelect } from "./index.js";
...
import { statingCandidates, competingFiller } from "./index.js";
...
test("BECOMING heard-clean — INHABITED: the generic gate survives a case-stripped source via a DISCOVERED kind", { skip: SKIP }, async () => {
  ...
  // S2-heard end to end.
  const { discoverCompanyKinds, frameWords } = await import("./index.js");
  const heard =
