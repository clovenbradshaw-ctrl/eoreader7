...
export const ARCHONS = Object.freeze([
  ...
  {
    handle: "osgood",
    name: "Charles E. Osgood",
    organ: "kernel/kind-graph-structure.js",
    role: "the predicate-resonance archon — an injected embedding reranks what the lemma-aware mechanical tier already surfaced as distinct, disclosing the likeness, never merging it",
    pdStatus: "fair-use",
    work: "With George Suci and Percy Tannenbaum, built the semantic differential: a word's meaning placed as a point in a measured space, so the distance between two words' points is a number a study can report, never a claim that the two words ARE each other. Applied here to two predicates witnessed on the same entity: an injected embedding reports how far apart they sit; the mechanical tier's own verdict that they are distinct stands untouched beside it.",
    source: "Osgood, Suci & Tannenbaum, The Measurement of Meaning (1957)",
    credit: "Charles Osgood — meaning placed as a point in a measured space; the distance between two points is reported, never declared identity (1957).",
    topics: ["resonance", "embedding", "similarity", "distance", "semantic", "rerank", "predicate", "synonym", "paraphrase"],
  },
]);
