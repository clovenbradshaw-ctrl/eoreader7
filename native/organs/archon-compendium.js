...
export const ARCHONS = Object.freeze([
  ...
  },
  {
    handle: "sullivan",
    name: "Anne Sullivan",
    organ: "eval/lavar/english-ladder.mjs",
    role: "the curriculum archon — a language is learned layer by layer, sound before script before pattern before meaning; the connection between a sign and the thing it names is earned, one layer holding before the next is offered, never assumed or hand-waved past",
    pdStatus: "fair-use",
    work: "Helen Keller's teacher — “Teacher,” in Keller's own lifelong word for her. Deaf-blind from nineteen months old, Keller had signs (finger-spelled letters Sullivan pressed into her palm) with no connection to what they named, until the well-house breakthrough of April 5, 1887: water flowing over one hand while Sullivan spelled w-a-t-e-r into the other, and the sign suddenly meant something. Everything before that moment was mimicry; everything after was language. The discipline applied here to English itself: a curriculum graded by period and region (when and where the English was written), each rung's acquisition ordered sound, then script, then heard pattern, then meaning — a layer is not claimed learned until the one beneath it has actually connected, the same distinction the well-house drew.",
    ...
    topics: ["language", "curriculum", "pedagogy", "ladder", "period", "region", "english", "diachronic", "layered", "acquisition", "grounding"],
  },
  {
    handle: "tadoma",
