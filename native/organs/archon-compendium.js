...
export const ARCHONS = Object.freeze([
  ...
  },
  {
    ...
    organ: "adapters/text/verb-synonym-disclosure.js",
    role: "the disclosed-synonym archon — groups candidate verbs an embedding places close, never claiming two words are one",
    pdStatus: "public-domain",
    work: "The physician who built the Thesaurus of English Words and Phrases (1852) by CLASSIFYING words into groups of related meaning — never asserting that two grouped words are identical, only that a reader reaching for one may mean the other. A thesaurus entry stands beside a dictionary entry; it never rewrites it. That is exactly the posture this organ takes toward the mechanical vocabulary discoverRelationVocab/morphology.js already earned: an embedding-ranked cluster of candidate verbs ('captured' near 'took') is laid down as a second, disclosed grouping — never merged into one canonical form, and never itself licensing a triple.",
    source: "Roget's Thesaurus of English Words and Phrases (1852)",
    credit: "Peter Mark Roget — a thesaurus groups words by relation, never claims two are one; his Thesaurus (1852) is the ground this organ's disclosed synonym clusters stand on.",
    topics: ["synonym", "synonymy", "paraphrase", "thesaurus", "cluster", "rerank", "embedding", "verb", "disclosure", "act", "same act"],
  },
]);
