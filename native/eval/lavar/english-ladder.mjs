  ...
  },
  {
    ...
    corpus: {
      ...
      onDisk: [
        ...
        "15-western-canon/marlowe/doctor-faustus-1604-quarto.txt — Dyce's 19th-century scholarly edition of the 1604 quarto (Gutenberg eBook #779, verified via the live catalog page, not guessed), Marlowe's own most-read play. Note: Dyce's is an EDITED text, not period-original spelling like the First Folio Henry IV file above — the file's own header says so. Real L2 run this session (discoverNominalBeings, minOccurrences 3, pos-prior-eng.json): 254 beings; top 10 doctor=70, soul=55, hell=53, horse=39, scholars=37, spirits=36, history=34, robin=30, angel=30, emperor=29 — every one real thematic content of the play (soul/hell/spirits/angel is the damnation plot itself; robin and the emperor are real named characters), zero HTML/caption-style debris.",
      ],
      missing: [
        "The rest of Marlowe: Tamburlaine (2 parts), The Jew of Malta, Edward II, Massacre at Paris, Dido Queen of Carthage, Hero and Leander — all on Gutenberg, real ebook numbers confirmed via the catalog search this session, none fetched yet.",
