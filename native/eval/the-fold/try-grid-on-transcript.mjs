...
import { tokenize as engineTokenize } from "../../../legacy-eoreader6.1/packages/engine/perceiver/text/material.js";
...
const path = process.argv[2] ?? "native/eval/the-fold/results/adversarial-dialogue-hiroshima-gemma2b-v3-edgegate.jsonl";
